...
class InlineQueryResultCachedGif extends \Tarik02\Telegram\Entities\InlineQueryResult implements \Tarik02\Telegram\Contracts\Payloadable
{
     ...
     * @return string
     */
    public function gifFileId(): string
    {
        return $this->payload['gif_file_id'];
    }
     ...
     * @return self
     */
    public function withGifFileId(string $gifFileId): self
    {
        $payload = $this->payload;
        $payload['gif_file_id'] = $gifFileId;
        return new self($payload);
    }
    ...
    /**
     * @return \Tarik02\Telegram\Collections\InlineQueryResultCachedGifCollection
     */
    public static function collection(): \Tarik02\Telegram\Collections\InlineQueryResultCachedGifCollection
    {
        return \Tarik02\Telegram\Collections\InlineQueryResultCachedGifCollection::make();
    }
