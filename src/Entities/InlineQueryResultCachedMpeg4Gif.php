 ...
 */
class InlineQueryResultCachedMpeg4Gif extends \Tarik02\Telegram\Entities\InlineQueryResult implements \Tarik02\Telegram\Contracts\Payloadable
{
    /**
     ...
     * @return string
     */
    public function mpeg4FileId(): string
    {
        return $this->payload['mpeg4_file_id'];
    }
     ...
     * @return self
     */
    public function withMpeg4FileId(string $mpeg4FileId): self
    {
        $payload = $this->payload;
        $payload['mpeg4_file_id'] = $mpeg4FileId;
        return new self($payload);
    }
    ...
    /**
     * @return \Tarik02\Telegram\Collections\InlineQueryResultCachedMpeg4GifCollection
     */
    public static function collection(): \Tarik02\Telegram\Collections\InlineQueryResultCachedMpeg4GifCollection
    {
        return \Tarik02\Telegram\Collections\InlineQueryResultCachedMpeg4GifCollection::make();
    }
