 ...
 */
class InlineQueryResultCachedPhoto extends \Tarik02\Telegram\Entities\InlineQueryResult implements \Tarik02\Telegram\Contracts\Payloadable
{
    /**
    ...
    {
        return $this->payload['photo_file_id'];
    }
     ...
     * @return self
     */
    public function withPhotoFileId(string $photoFileId): self
    {
        $payload = $this->payload;
    ...
    /**
     * @return \Tarik02\Telegram\Collections\InlineQueryResultCachedPhotoCollection
     */
    public static function collection(): \Tarik02\Telegram\Collections\InlineQueryResultCachedPhotoCollection
    {
        return \Tarik02\Telegram\Collections\InlineQueryResultCachedPhotoCollection::make();
    }
